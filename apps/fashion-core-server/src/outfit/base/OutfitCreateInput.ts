...
class OutfitCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TryOnSessionCreateNestedManyWithoutOutfitsInput,
  })
  @ValidateNested()
  @Type(() => TryOnSessionCreateNestedManyWithoutOutfitsInput)
  @IsOptional()
  @Field(() => TryOnSessionCreateNestedManyWithoutOutfitsInput, {
    nullable: true,
  })
  tryOnSessions?: TryOnSessionCreateNestedManyWithoutOutfitsInput;
}

export { OutfitCreateInput as OutfitCreateInput };
